...
class PortController extends BaseController{
	...
	function index($fieldname = null , $fieldvalue = null){
		...
		$this->view->page_title ="Port";
		$this->view->render('port/list.php' , $data ,'main_layout.php');
	}
	/**
     * Load csv|json data
     * @return data
	...
	function import_data(){
		...
		$list_page = (!empty($_POST['redirect']) ? $_POST['redirect'] : 'port/list');
	...
	function view( $rec_id = null , $value = null){
		...
		if(!empty($record)){
			$this->view->page_title ="View  Port";
			$this->view->render('port/view.php' , $record ,'main_layout.php');
		}
		else{
			$page_error = null;
			if($db->getLastError()){
	...
	function add(){
		...
		$this->view->page_title ="Add New Port";
		$this->view->render('port/add.php' ,null,'main_layout.php');
	}
	/**
     * Edit Record Action 
	...
	function edit($rec_id = null){
		...
		$this->view->page_title ="Edit  Port";
		if(!empty($data)){
			$this->view->render('port/edit.php' , $data, 'main_layout.php');
		}
		else{
			if($db->getLastError()){
