        ...
        <div class="container">
            ...
            <div class="row ">
                ...
                <div class="col-12 comp-grid">
                    <h3 class="record-title">Add New Port</h3>
            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="port-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("port/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        ...
                                                        <select required=""  id="ctrl-category" name="category"  placeholder="Select a value ..."    class="custom-select" >
                                                            ...
                                                            <?php 
                                                            $category_options = $comp_model -> port_category_option_list();
                                                ...
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        ...
                                                        <select required=""  id="ctrl-author" name="author"  placeholder="Select a value ..."    class="custom-select" >
                                                            ...
                                                            <?php 
                                                            $author_options = $comp_model -> port_author_option_list();
